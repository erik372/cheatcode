...
library("tidyverse")
th11 <- theme(axis.title.y=element_text(angle=0), text=element_text(size=11))
...
g_minmax <- p11 +
  ...
  annotate("text", x=2.2, y=2.2, label="Minimum value", vjust=1.6, size=4) +
  annotate("text", x=5, y=10, label="Maximum value", vjust=-1, size=4)
g_minmax
```
...
g_localminmax <- ggplot() +
  ...
  th11 +
  annotate("text", x=-.33, y=3, label="Local max.", size=4) +
  annotate("text", x=1, y=0, label="Local min.", size=4) +
  annotate("text", x=1.5, y=6, label="Global max.", size=4) +
  annotate("text", x=-.7, y=-4, label="Global min.", size=4) +
...
g_min_terrace <- ggplot(tibble(x=-10:10)) +
  ...
  annotate(geom='text', x=-.5, y=-2, label="(-0.5, -1.7)", size=4) +
  annotate(geom='text', x=1, y=.33, label="(1, 0)", size=4) +
  geom_vline(xintercept=0, alpha=.3) +
  geom_hline(yintercept=0, alpha=.3)
g_min_terrace
```
