...
```{r 15_counterfactual_analysis_ex_1_pdf, echo=FALSE, results='asis'}
if (knitr::is_latex_output()) {
  ex_items <- list(
    list(
      ...
      a = "(a)\\begin_inset Formula \\(\\hat{\\tau}=80-60=20\\) , (b)\\begin_inset Formula \\(\\tau=80-65=15\\) , (c) selection bias or confounding.\n\n"
    ),
    list(
    ...
    list(
      ...
      a = "(a)\\begin_inset Formula \\(\\bar{Y}_{B}=7.5,\\bar{Y}_{K}=5.0\\) , (b)\\begin_inset Formula \\(\\hat{\\tau}=2.5\\) , (c) random assignment to treatment and control groups.\n\n"
    ),
    list(
    ...
    list(
      ...
      a = "(a)\\begin_inset Formula \\(n/N=50/10000=0.005\\) , (b) the population mean \\(\\mu\\) , (c) ensures the sample is representative of the population.\n\n"
    ),
    list(
