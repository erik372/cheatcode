...
g_nonlin_first <- ggplot() +
  ...
  annotate('label', x=1, y=0, label="f(x)", size=4) +
  annotate('label', x=.8, y=4, label="g(x)", size=4) +
  annotate('label', x=.3, y=10.3, label="h(x)", size=4) +
...
g_nonlinear_1 <- ggplot() +
  ...
  geom_hline(yintercept=0, alpha=.3) +
  theme(axis.title.y=element_text(angle=0), text=element_text(size=11)) +
  annotate('text', x=2.5, y=3, size=4, label=TeX("$y = x$")) +
  annotate('text', x=3.9, y=4.8, hjust=1, size=4, label=TeX("$y = (x - 2)^2$")) +
...
g_twoequilibrias <- ggplot() +
  ...
  labs(x="x", y="y") +
  theme(axis.title.y=element_text(angle=0), text=element_text(size=11)) +
  annotate('text', x=.75, y=.35, hjust=0, size=4,
           label=TeX("$y = \\left(2 - \\frac{1}{x^2} \\right) ^{ \\frac{1}{2}}$")) +
  annotate('text', x=1.05, y=1.17, hjust=1, size=4, label=TeX("$y = x^2$"))
g_twoequilibrias
```
...
g_nonlin_2 <- ggplot() +
  ...
  geom_vline(xintercept=0, alpha=.3) +
  geom_hline(yintercept=0, alpha=.3) +
  annotate('label', x=-2, y=-7, size=4, label=TeX("$y = 20 - 2x^2$")) +
  annotate('label', x=-2, y=12, size=4, label=TeX("$y = -10 + x^2$")) +
  labs(x="x", y="y") +
  theme(axis.title.y=element_text(angle=0), text=element_text(size=11))
g_nonlin_2
```
...
g_smoking <- ggplot() +
  ...
  theme(axis.title.y=element_text(angle=0, hjust=0), text=element_text(size=11)) +
  labs(x="Maria's smoking", y="Erik's \nsmoking") +
  annotate('text', x=0.25, y=.8, hjust=0, size=4, label=TeX("$x = y^2$")) +
  annotate('text', y=0.25, x=.8, hjust=1, size=4, label=TeX("$y = x^2$")) +
  annotate('label', x=.66, y=0, size=4, label="Nobody's smoking") +
  annotate('label', x=.5, y=1, size=4, label="Both smoking") +
...
g_p_polynom <- ggplot() +
  ...
  theme(axis.title.y=element_blank(), text=element_text(size=11)) +
  labs(x="P") +
  annotate('text', x=.9, y=.3, size=4, hjust=1,
