...
<img src="04-functions-graphs_files/figure-html/illustration-av-funktionen-1.png" alt="Illustration of the function $ y=10x $" width="71%" />
<p class="caption">(\#fig:illustration-av-funktionen)Illustration of the function $ y=10x $</p>
</div>
...
<div class="figure" style="text-align: left">
<img src="04-functions-graphs_files/figure-html/tva-funktioner-i-samma-diagram-1.png" alt="Two functions in the same graph" width="71%" />
<p class="caption">(\#fig:tva-funktioner-i-samma-diagram)Two functions in the same graph</p>
</div>
...
<div class="figure" style="text-align: left">
<img src="04-functions-graphs_files/figure-html/positiv-negativ-och-ingen-lutning-1.png" alt="Positive slope, negative slope and no slope" width="71%" />
<p class="caption">(\#fig:positiv-negativ-och-ingen-lutning)Positive slope, negative slope and no slope</p>
</div>
...
<div class="figure" style="text-align: left">
<img src="04-functions-graphs_files/figure-html/en-rat-linje-1.png" alt="A straight line" width="71%" />
<p class="caption">(\#fig:en-rat-linje)A straight line</p>
</div>
...
<div class="figure" style="text-align: left">
<img src="04-functions-graphs_files/figure-html/ex-pa-rata-linjer-1.png" alt="Examples of the linear function" width="71%" />
<p class="caption">(\#fig:ex-pa-rata-linjer)Examples of the linear function</p>
</div>

 

<div class="figure" style="text-align: left">
<img src="04-functions-graphs_files/figure-html/fyra-anonyma-linjer-1.png" alt="Four lines in the same graph" width="71%" />
<p class="caption">(\#fig:fyra-anonyma-linjer)Four lines in the same graph</p>
</div>
...
<div class="figure" style="text-align: left">
<img src="04-functions-graphs_files/figure-html/ickelinjart-ex-1.png" alt="The line for the function $ y=3+x^{2}$" width="71%" />
<p class="caption">(\#fig:ickelinjart-ex)The line for the function $ y=3+x^{2}$</p>
</div>
...
<div class="figure" style="text-align: left">
<img src="04-functions-graphs_files/figure-html/en-icke-kontinuerlig-funktion-1.png" alt="A non-continuous function" width="71%" />
<p class="caption">(\#fig:en-icke-kontinuerlig-funktion)A non-continuous function</p>
</div>
