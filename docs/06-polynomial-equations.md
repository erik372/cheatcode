...
Table: Derivation of the quadratic formula (\#tab:harledning-av-pq-formeln)
...
Now it remains to find the remaining solutions to equation \@ref(eq:exempel-3egrad) by calculating what is left in the parenthesis in equation \@ref(eq:3egradsekv-parentes) . This we did above when we derived the quadratic formula, in equation \@ref(eq:pq-harledning-1) .
