...
<div class="figure">
<img src="22-probability-continuous_files/figure-html/unicont-1.png" alt="Uniform continuous probability: density function (left) and cumulative distribution function (right)." width="720" />
<p class="caption">(\#fig:unicont)Uniform continuous probability: density function (left) and cumulative distribution function (right).</p>
</div>
...
<div class="figure">
<img src="22-probability-continuous_files/figure-html/exponential-pdf-cdf-1.png" alt="The exponential distribution: density function, \(f(x)\), and cumulative distribution function, \(F(x)\)." width="600" />
<p class="caption">(\#fig:exponential-pdf-cdf)The exponential distribution: density function, \(f(x)\), and cumulative distribution function, \(F(x)\).</p>
</div>
...
<div class="figure">
<img src="22-probability-continuous_files/figure-html/gamma-pdf-cdf-1.png" alt="The gamma distribution with \(k=3\): density function, \(f(x)\), and the cumulative distribution, \(F(x)\)." width="749.76" />
<p class="caption">(\#fig:gamma-pdf-cdf)The gamma distribution with \(k=3\): density function, \(f(x)\), and the cumulative distribution, \(F(x)\).</p>
</div>
...
<div class="figure">
<img src="22-probability-continuous_files/figure-html/chi2-pdf-cdf-1.png" alt="Chi-square distribution: density function, \(f(x)\), and cumulative distribution function, \(F(x)\)." width="690.24" />
<p class="caption">(\#fig:chi2-pdf-cdf)Chi-square distribution: density function, \(f(x)\), and cumulative distribution function, \(F(x)\).</p>
</div>
...
Table: (\#tab:freq-dist)Frequency distribution
...
Table: (\#tab:chi2-table)The chi-squared distribution: critical values with respect to degrees of freedom, \(r\), and cumulative probability
...
<div class="figure">
<img src="22-probability-continuous_files/figure-html/fdistro-pdf-cdf-1.png" alt="The F-distribution: density function, \(f(x)\), and cumulative distribution function, \(F(x)\)." width="690.24" />
<p class="caption">(\#fig:fdistro-pdf-cdf)The F-distribution: density function, \(f(x)\), and cumulative distribution function, \(F(x)\).</p>
</div>
...
Table: (\#tab:f-table)The F-distribution: critical values with respect to the degrees of freedom df 1 and df 2, \(F(\text{df 1},\text{df 2})\).
