...
<div class="figure">
<img src="21-probability-discrete_files/figure-html/tva-tarningar-1.png" alt="Number of cases and result sum for two dice" width="768" />
...
<div class="figure">
<img src="21-probability-discrete_files/figure-html/dicemeans-1.png" alt="Law of large numbers: simulated means from a die (values 1–6) for increasing sample sizes. The dashed line marks the expected value 3.5." width="672" />
...
<div class="figure">
<img src="21-probability-discrete_files/figure-html/dice-pmf-cdf-1.png" alt="Probability mass function (top) and cumulative distribution function (bottom) for a uniform discrete probability distribution that can assume the integers 1 to 6." width="600" />
...
<div class="figure">
<img src="21-probability-discrete_files/figure-html/binomial-pmf-cdf-1.png" alt="Probability mass function (top) and cumulative distribution function (bottom) for a binomial distribution with \(n=10\) and \(p=0.5\)." width="600" />
...
<div class="figure">
<img src="21-probability-discrete_files/figure-html/bortkiewicz-1.png" alt="Deaths per cavalry corps per year (Bortkiewicz 1898)." width="600" />
