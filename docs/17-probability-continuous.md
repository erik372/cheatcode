...
<div class="figure">
<img src="17-probability-continuous_files/figure-html/unicont-1.png" alt="Uniform continuous probability: density function (left) and cumulative distribution function (right)." width="720" />
...
<div class="figure">
<img src="17-probability-continuous_files/figure-html/exponential-pdf-cdf-1.png" alt="The exponential distribution: density function, \(f(x)\), and cumulative distribution function, \(F(x)\)." width="600" />
...
<div class="figure">
<img src="17-probability-continuous_files/figure-html/gamma-pdf-cdf-1.png" alt="The gamma distribution with \(k=3\): density function, \(f(x)\), and the cumulative distribution, \(F(x)\)." width="749.76" />
...
<div class="figure">
<img src="17-probability-continuous_files/figure-html/chi2-pdf-cdf-1.png" alt="Chi-square distribution: density function, \(f(x)\), and cumulative distribution function, \(F(x)\)." width="690.24" />
...
<div class="figure">
<img src="17-probability-continuous_files/figure-html/fdistro-pdf-cdf-1.png" alt="The F-distribution: density function, \(f(x)\), and cumulative distribution function, \(F(x)\)." width="690.24" />
