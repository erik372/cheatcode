...
<img src="11-optimization-functions_files/figure-html/en-funktion-med-min-och-max-1.png" alt="A function with a maximum and minimum value" width="71%" />
<p class="caption">(\#fig:en-funktion-med-min-och-max)A function with a maximum and minimum value</p>
</div>
...
<div class="figure" style="text-align: left">
<img src="11-optimization-functions_files/figure-html/extrempunkt-1.png" alt="The function $y=f\left(x\right)=x^{2}$" width="71%" />
<p class="caption">(\#fig:extrempunkt)The function $y=f\left(x\right)=x^{2}$</p>
</div>
...
<div class="figure" style="text-align: left">
<img src="11-optimization-functions_files/figure-html/linjen-for-h-k-1.png" alt="The line for $h\left(k\right)=k^{2}-k+3$ and its minimum point" width="71%" />
<p class="caption">(\#fig:linjen-for-h-k)The line for $h\left(k\right)=k^{2}-k+3$ and its minimum point</p>
</div>
...
<div class="figure" style="text-align: left">
<img src="11-optimization-functions_files/figure-html/lokala-globala-min-max-1.png" alt="Local and global minimum and maximum points" width="71%" />
<p class="caption">(\#fig:lokala-globala-min-max)Local and global minimum and maximum points</p>
</div>
...
<div class="figure" style="text-align: left">
<img src="11-optimization-functions_files/figure-html/f-minimi-terass-1.png" alt="Function with minimum and terrace point" width="71%" />
<p class="caption">(\#fig:f-minimi-terass)Function with minimum and terrace point</p>
</div>
