...
<img src="13-integration_files/figure-html/integral-konstant-c-olika-varden-1.png" alt="The primitive function $G\left(x\right)$ with different constants $C$" width="71%" />
<p class="caption">(\#fig:integral-konstant-c-olika-varden)The primitive function $G\left(x\right)$ with different constants $C$</p>
</div>
...
<div class="figure" style="text-align: left">
<img src="13-integration_files/figure-html/arean-under-y-4-1.png" alt="The area under the function $y=f\left(x\right)=4,\forall0\leq x\leq4$" width="71%" />
<p class="caption">(\#fig:arean-under-y-4)The area under the function $y=f\left(x\right)=4,\forall0\leq x\leq4$</p>
</div>

 

<div class="figure" style="text-align: left">
<img src="13-integration_files/figure-html/arean-for-y-x-1.png" alt="The function $y=f\left(x\right)=x$ and the area under the line" width="71%" />
<p class="caption">(\#fig:arean-for-y-x)The function $y=f\left(x\right)=x$ and the area under the line</p>
</div>
...
<div class="figure" style="text-align: left">
<img src="13-integration_files/figure-html/y-x2-area-1.png" alt="The function $y=f\left(x\right)=x^{2}$" width="71%" />
<p class="caption">(\#fig:y-x2-area)The function $y=f\left(x\right)=x^{2}$</p>
</div>
...
<div class="figure" style="text-align: left">
<img src="13-integration_files/figure-html/area-over-och-under-x-1.png" alt="Area above and under the $x$ -axis" width="71%" />
<p class="caption">(\#fig:area-over-och-under-x)Area above and under the $x$ -axis</p>
</div>
...
<div class="figure" style="text-align: left">
<img src="13-integration_files/figure-html/arean-mellan-tva-funktioner-1.png" alt="The area between two functions" width="71%" />
<p class="caption">(\#fig:arean-mellan-tva-funktioner)The area between two functions</p>
</div>
...
<div class="figure" style="text-align: left">
<img src="13-integration_files/figure-html/lorenz-ex-1-1.png" alt="Example with a Lorenz curve" width="71%" />
<p class="caption">(\#fig:lorenz-ex-1)Example with a Lorenz curve</p>
</div>
...
<div class="figure" style="text-align: left">
<img src="13-integration_files/figure-html/ginikoefficienten-1.png" alt="The Gini coefficient" width="71%" />
<p class="caption">(\#fig:ginikoefficienten)The Gini coefficient</p>
</div>
...
<div class="figure" style="text-align: left">
<img src="13-integration_files/figure-html/gini-i-teorin-1.png" alt="Two measures of income distribution" width="71%" />
<p class="caption">(\#fig:gini-i-teorin)Two measures of income distribution</p>
</div>
