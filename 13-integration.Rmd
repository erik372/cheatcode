...
g_y4 <-
  ggplot() +
  geom_area(aes(x=0:4, y=4:4)) + xlim(0,5) + ylim(0,5) +
...
g_area_x2 <- ggplot(tibble(x=-4:7)) +
  stat_function(fun=function(x) x^2, xlim=c(-4,7), color="#F8766D") +
...
g_area2func <- ggplot() +
  stat_function(fun=function(x) -x + x^3 -x^2 +10, geom='ribbon',
                aes(ymax=after_stat(-x + x^3 -x^2 +10),
                    ymin=after_stat(2 + 2*x -.5*x^2)), color="#F8766D") +
...
g_gini1 <- ggplot() +
  stat_function(fun=function(x) x, geom='area', color="#F8766D") +
  stat_function(fun=function(x) x^3, geom='area', color="#00BFC4") +
  ...
  annotate('text', x=.1, y=.8, hjust=0, size=4,
...
g_ginitheory <- ggplot() +
  stat_function(fun=function(x) x, color="#F8766D") +
  stat_function(fun=function(x) x^2, geom='area', linetype='dashed', color="#00BFC4") +
  stat_function(fun=function(x) x^3, geom='area', color="#7CAE00") +
  coord_fixed() +
