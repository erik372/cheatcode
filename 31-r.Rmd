...
```{r r-window, echo=FALSE, fig.cap="The program R", out.width="70%", fig.align="center"}
knitr::include_graphics("images/R_window.png")
```

```{r rstudio-window, echo=FALSE, fig.cap="The program RStudio", out.width="90%", fig.align="center"}
...
```{r r-joins, echo=FALSE, fig.cap="Merging of table\\_1 and table\\_2", out.width="90%", fig.align="center"}
knitr::include_graphics(c("images/r fulljoin1.png",
                           "images/r_innerjoin1.png",
                           "images/r_leftjoin1.png",
                           "images/r_rightjoin1.png"))
```
...
```{r r-cor, echo=FALSE, fig.cap="Results of cor()", out.width="50%", fig.align="center"}
knitr::include_graphics("images/R cor.png")
```
...
```{r r-lm-results, echo=FALSE, fig.cap="Results of lm()", out.width="60%", fig.align="center"}
knitr::include_graphics("images/r lm results1.png")
```
...
```{r r-lm-summary, echo=FALSE, fig.cap="Results from lm() and summary()", out.width="70%", fig.align="center"}
knitr::include_graphics("images/r lm summary1.png")
```
...
```{r r-stargazer, echo=FALSE, fig.cap="Results from stargazer()", out.width="60%", fig.align="center"}
knitr::include_graphics("images/r stargazer1.png")
```
...
```{r r-graf1, echo=TRUE, message=FALSE, warning=FALSE, fig.cap="A graph with a line and dots"}
library(tidyverse)
...
```{r r-graf2, echo=TRUE, message=FALSE, warning=FALSE, fig.cap="A graph with a line and dots (styled)"}
tibble(time=2015:2022,
  my_variable = c(3,2,4,5,3,5,6,4)) %>%
ggplot(aes(x=time, y=my_variable)) +
...
```{r r-graf3, echo=TRUE, message=FALSE, warning=FALSE, fig.cap="A graph with colored groups"}
...
```{r r-graf-lm, echo=TRUE, message=FALSE, warning=FALSE, fig.cap="A graph with a regression line"}
tibble(x=c(3,4,6,7),
y=c(5,2,3,1)) %>%
ggplot(aes(x=x,y=y)) +
geom_point() +
...
```{r r-histogram, echo=TRUE, message=FALSE, warning=FALSE, fig.cap="Histogram created with ggplot()"}
# Define random seed
set.seed(1)
...
```{r r-func-graph, echo=TRUE, message=FALSE, warning=FALSE, fig.cap="A graph with a mathematical function"}
ggplot() +
...
```{r r-patchwork, echo=TRUE, message=FALSE, warning=FALSE, fig.cap="Graphs organized with patchwork"}
library(patchwork)
# Create a chart
chart_1 <- ggplot() +
geom_function(fun=function(x) x^2) +
...
```{r r-map-table, echo=FALSE, fig.cap="Table created with map()", out.width="40%", fig.align="center"}
knitr::include_graphics("images/r tabell fr map1.png")
```
...
```{r r-tcb-gdp, echo=TRUE, fig.cap="GDP per Working Hour"}
tcb_data %>% ggplot(
...
```{r r-tcb-index-plot, echo=TRUE, fig.cap="Indexed GDP per Working Hour"}
tcb_data %>% ggplot(
...
```{r r-koeff-table, echo=FALSE, fig.cap="Table with estimated coefficients", out.width="35%", fig.align="center"}
knitr::include_graphics("images/r table est koeff1.png")
```
