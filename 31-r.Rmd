...
```{r r-window, echo=FALSE, fig.cap="The program R", out.width="70%", fig.align="left"}
knitr::include_graphics("images/R_window.png")
```

```{r rstudio-window, echo=FALSE, fig.cap="The program RStudio", out.width="90%", fig.align="left"}
...
```{r r-joins, echo=FALSE, fig.cap="Merging of table\\_1 and table\\_2", out.width="90%", fig.align="left"}
...
```{r r-cor, echo=FALSE, fig.cap="Results of cor()", out.width="50%", fig.align="left"}
...
```{r r-lm-results, echo=FALSE, fig.cap="Results of lm()", out.width="60%", fig.align="left"}
...
```{r r-lm-summary, echo=FALSE, fig.cap="Results from lm() and summary()", out.width="70%", fig.align="left"}
...
```{r r-stargazer, echo=FALSE, fig.cap="Results from stargazer()", out.width="60%", fig.align="left"}
...
```{r r-map-table, echo=FALSE, fig.cap="Table created with map()", out.width="40%", fig.align="left"}
...
```{r r-koeff-table, echo=FALSE, fig.cap="Table with estimated coefficients", out.width="35%", fig.align="left"}
