...
```{r det-ar-latt-att-lura-sig-sjalv, echo=FALSE, message=FALSE, out.width="71%", fig.cap="How far is it between the arrowheads?"}
library("tidyverse")
g_falsearrows <- ggplot() +
  stat_function(fun=function(x) 5, xlim=c(0,2), color="forestgreen",
                arrow=arrow(length=unit(.47,'cm'), ends='both', type='open')) +
  stat_function(fun=function(x) 7, xlim=c(.999999999,1), color="forestgreen",
                arrow=arrow(length=unit(.47,'cm'), ends='last', type='open')) +
  stat_function(fun=function(x) 7, xlim=c(3,3.00000001), color="forestgreen",
                arrow=arrow(length=unit(.47,'cm'), ends='first', type='open')) +
  stat_function(fun=function(x) 7, xlim=c(1,3), color="forestgreen") +
  annotate('segment', x=7, xend=7, y=4, yend=3.999999999999, color="purple",
           arrow=arrow(length=unit(.47,'cm'), ends='last', type='open')) +
  annotate('segment', x=7, xend=7, yend=2, y=1.9999999999999, color="purple",
           arrow=arrow(length=unit(.47,'cm'), ends='last', type='open')) +
  annotate('segment', y=5, yend=5.00000000001, xend=6, x=6, color="purple",
           arrow=arrow(length=unit(.47,'cm'), ends='first', type='open')) +
  annotate('segment', yend=7, y=7.00000000001, xend=6, x=6, color="purple",
           arrow=arrow(length=unit(.47,'cm'), ends='first', type='open')) +
